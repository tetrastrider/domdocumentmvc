...
<span id='catet'>
<option value="" class="cat"><cate></cate></option>
</span>
</select></label>
...
<pd id='pdd'>
<option value="" class='pagina'><pagina></pagina></option>
 <pd>
</select></label>
...
<label class="custom-select">
     ...
     <sc id='sc'>
      <option value="" class='guu'><guion></guion></option>
      </sc>
</select></label>
...
<!---pxu---->
  <div class='envase mod'>
   <center><p><i class="fa fa-flag" aria-hidden="true"></i>&nbsp; Mis publicaciones  <pxu></pxu></p></center>
  </div>
  <!---pxu---->

  <!---tpub---->
  <div class='envase mod'>
   <center><p><i class="fa fa-flag-o" aria-hidden="true"></i>&nbsp; Total publicaciones  <tpub></tpub></p></center>
  </div>
  <!---tpub---->
  
  <!---tv---->
  <div class='envase mod'>
   <center><p><i class="fa fa-eye-slash" aria-hidden="true"></i>&nbsp; Mis visitas  <mvisitas></mvisitas></p></center>
  </div>
  <!---tv---->

  <!---tv---->
  <div class='envase mod'>
   <center><p><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; Total visitas  <tvisitas></tvisitas></p></center>
  </div>
  <!---tv---->

  <!---mcom---->
  <div class='envase mod'>
   <center><p><i class="fa fa-comment-o" aria-hidden="true"></i>&nbsp; Mis comentarios  <mcoment></mcoment></p></center>
  </div>
  <!---mcom---->

  <!---tcom---->
  <div class='envase mod'>
   <center><p><i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp; Total comentarios  <tcoment></tcoment></p></center>
  </div>
  <!---tcom---->
