...
public function index(){
    ...
    $cata=['cate'=>['co','categoria'],'*[@class="cat"]'=>['value','categoria']];
    $this->vista->each('catet',$this->modelo->categoria(),$cata);
    $pdd=['pagina'=>['co','pagina'],'*[@class="pagina"]'=>['value','pagina']];
    $this->vista->each('pdd',$this->vistastpl(),$pdd);
    $sc=['guion'=>['co','guion'],'*[@class="guu"]'=>['value','guion']];
    $this->vista->each('sc',$this->jsfiles(),$sc);
