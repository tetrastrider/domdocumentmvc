<?php 
 class editarc extends controlador{
  ...
  public function index(){ 
    ...
    $this->vista->mset('thegod',$this->modelo->noticiasxid($_GET['i']));
    $this->vista->mset('theg',$this->modelo->noticiasxid($_GET['i'])); 
        }
    ...
    $this->vista->set('categorias',$this->modelo->categoria());
     $this->vista->ver();
      }
